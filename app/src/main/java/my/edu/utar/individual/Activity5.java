...
public class Activity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiles[25] = findViewById(R.id.button26);
        tiles[26] = findViewById(R.id.button27);
        tiles[27] = findViewById(R.id.button28);
        tiles[28] = findViewById(R.id.button29);
        tiles[29] = findViewById(R.id.button30);
        tiles[30] = findViewById(R.id.button31);
        tiles[31] = findViewById(R.id.button32);
        tiles[32] = findViewById(R.id.button33);
        tiles[33] = findViewById(R.id.button34);
        tiles[34] = findViewById(R.id.button35);
        tiles[35] = findViewById(R.id.button36);
    }
    ...
    private void startGame() {
                ...
                public void onClick(View view) {
                    if (index == redTileIndex) {
                        ...
                        if (clickedCount == numTiles) {
                            ...
                            Toast.makeText(Activity5.this, "You win!", Toast.LENGTH_SHORT).show();
                        } else {
        ...
        countDownTimer = new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                countDownTimer.cancel();
                Toast.makeText(Activity5.this, "Time's up! You lose!", Toast.LENGTH_SHORT).show();
                score = 0;
                for (int i = 0; i < numTiles; i++) {
                    tiles[i].setOnClickListener(null);
